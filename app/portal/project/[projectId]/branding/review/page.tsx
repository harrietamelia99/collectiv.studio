...
/** Canonical route: `/branding/proofs`. */
export default async function ProjectBrandingReviewLegacyRedirect({ params }: Props) {
  ...
  redirect(`/portal/project/${project.id}/branding/proofs`);
}
